...
Authoritative rules live in [AGENTS.md](../../../AGENTS.md); this skill is the
quick-reference Codex should apply automatically when touching the codebase.
...
editing dicts. See AGENTS.md → Localization (i18n).
